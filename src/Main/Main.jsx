                    ...
                    <div className='catalog_toolbar_right'>
                        <div className='dropdown'>
                            ...
                            <div className='dropdown_menu'>
                                {isDropdownClicked && <>
                                    <button className='dropdown_button2' onClick={() => {setIsDropdownClicked(false); setSelected("Сортировка по рейтингу")}}>Рейтингу</button>
                                    <button className='dropdown_button3' onClick={() => {setIsDropdownClicked(false); setSelected("Сортировка по цене")}}>Цене</button>
                                </>}
                            </div>
                        </div>
                    </div>
                ...
                <section className="container">
                    {loading ? (
                        <div className="loader">
                            ...
                            <div className='loader_icon'><LottieAnimation animationData={lottieflow} loop/></div>
                        </div>
                        ) : 
                    ...
                    {selectedProduct && <div className='modal'>
                        ...
                        <section className='modal_desc'>
                            <button onClick={() => setSelectedProduct(null)} className='close_button'>
                                <img src={closeIcon} className='close_logo'/>
                            </button>
                        ...
                        <section className='modal_full_desc'>
                                {<span className='modal_desc_header_text'>Итог:</span>} {<span className='modal_desc_text'>{selectedProduct.rating} - {selectedProduct.description}</span>}
                        </section>
                    </div>}
                </section>
            </div>
